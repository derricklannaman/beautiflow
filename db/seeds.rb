...
s1 = Stylist.create(:first_name => "Senia", :last_name => "Lannaman", :password => "password", :stylist_email => "email@email.com")
s2 = Stylist.create(:first_name => "Derrick", :last_name => "Lannaman", :password => "password", :stylist_email => "email@email.com")
s3 = Stylist.create(:first_name => "Mateo", :last_name => "Lannaman", :password => "password", :stylist_email => "email@email.com")
s4 = Stylist.create(:first_name => "Milan", :last_name => "Lannaman", :password => "password", :stylist_email => "email@email.com")
s5 = Stylist.create(:first_name => "Hello", :last_name => "Lannaman", :password => "password", :stylist_email => "email@email.com")
